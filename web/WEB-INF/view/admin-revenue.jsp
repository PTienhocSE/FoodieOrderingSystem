<%@ page contentType="text/html" pageEncoding="UTF-8" import="model.*,java.util.*,util.*"%> <%@ page import="model.Account" %> 
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a
                            ...
                            href="/OrderingSystem/adminRevenue"
                            >
                            <div
                                class="text-white text-center me-2 d-flex align-items-center justify-content-center"
                                >
        ...
        <main
            ...
            <div class="main">
                <center>
                    ...
                    <div
                        style="display: flex; margin-right: 60px; justify-content: flex-end"
                        >
                        <a
                            class="btn btn-primary btn-sm"
                            href="/OrderingSystem/adminRevenue?action=export"
                            >Export CSV File</a
                        >
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${shops}" var="shop">
                                    <tr>
                                        ...
                                        <td>${FormatString.formatCurrency(shop.vnPayRevenue)}</td>
                                        <td>${FormatString.formatCurrency(shop.codRevenue)}</td>
                                        <td>${FormatString.formatCurrency(shop.totalRevenue)}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
