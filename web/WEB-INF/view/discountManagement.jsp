                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="discountForm" action="discountManage" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="voucherCount" class="form-label"
...
<!--                                    <button
            ...
            <div
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="updateDiscountModalLabel">
                                Update Discount
                            </h5>
                            <button
                                type="button"
                        ...
                        <div class="modal-body">
                            <form
                                ...
                                <input
                                    ...
                                    />
                                <div class="mb-3">
                                    <label for="updateDiscountCode" class="form-label"
                                           >Discount Code</label
                                    >
                                    <input
                                        type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        type="number"
                                        class="form-control"
                                        id="updateVoucherCount"
                                        name="numberOfDiscount"
                                        required
                                        />
                                </div>
                                <div class="mb-3">
                                    <label for="updateDiscountPercentage" class="form-label"
                                           >Discount Percentage</label
                                    >
                                    <input
                                        type="number"
        ...
        <script>
            function generateDiscountCode() {
                var discountCode =
                        "DIS" + Math.random().toString(36).substring(2, 10).toUpperCase();
